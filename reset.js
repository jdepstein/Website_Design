...
const icecreams = [
  new IceCream({_id: "Bohemian Raspberry", flavor:["Vanilla"], fillings:["Fudge Brownies", "Raspberry"], description:"Is this the real life? Is this just fantasy?", image: "https://jewel925.com/wp-content/uploads/66037355_10156008306331621_553074801405591552_n.jpg"}),
  new IceCream({_id: "Don't Let Me Frown", flavor:["Vanilla"], fillings:["Cookie Dough", "Chocolate Fudge", "Chocolate Chips", "Caramel"], description:"The best thing you have tasted, you will not frown.", image:"https://d1wv4dwa0ti2j0.cloudfront.net/live/img/production/detail/ice-cream/cartons_sundae-extreme_sundaextreme-chocolate-chip-cookie-dough.jpg"}),
  new IceCream({_id: "Skunks Treat",flavor:["Vanilla"], fillings:["Oreo Cookie Bits"], description:"Creamy Vanilla Ice Cream with Home Made Oreo Cookie Bits", image: "https://lovingitvegan.com/wp-content/uploads/2018/06/Vegan-Cookies-and-Cream-Ice-Cream-17.jpg"}),
  new IceCream({_id: "Mocha-licious",flavor:["Coffee"], fillings:[], description:"No morning coffe? Mocha-licious will wake you up!", image: "https://www.thelittleepicurean.com/wp-content/uploads/2012/01/IMG_8537-1.jpg"}),
  new IceCream({_id: "Choc It Out", flavor:["Chocolate"], fillings:["Cookie Dough", "Chocolate chips"], description:"Choc It Out with some friends over our delicious dough!", image: "https://www.browneyedbaker.com/wp-content/uploads/2012/08/chocolate-chocolate-chip-cookie-dough-ice-cream-3-550.jpg"}),
  new IceCream({_id: "Vanilla Ice", flavor:["Vanilla"], fillings:[], description:"The Best Vanilla Ice-cream you'll ever taste!", image: "https://thebusybaker.ca/wp-content/uploads/2019/05/best-ever-no-churn-vanilla-ice-cream-fb-ig-2.jpg"}),
  new IceCream({_id: "Burst Your Bubble",   flavor:["Bubble Gum"], fillings:[], description:"Try Not to Burst Your Bubble!", image: "https://i0.wp.com/sugarandwine.com/wp-content/uploads/2016/07/Bubblegum-Ice-cream-Main.jpg?w=610"}),
  new IceCream({_id: "Fairy Floss", flavor:["Cotton Candy"], fillings:["Sprinkles"], description:"Your favorite county fair treat now available 24/7", image: "https://easyfamilyrecipeideas.com/wp-content/uploads/2019/07/Cotton-Candy-Ice-Cream-10-683x1024.jpg"}),
