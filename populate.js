...
const stores = [
  ...
  new Store({_id: "Sundae Fun #2", City: "Sweet", State: "MA", Street: "Berry Drive", Building_Number: 80, icecream:["Bohemian Raspberry"] }),
  new Store({_id: "SundaeFundae #3", City: "Milkshake", State: "IL", Street: "Rocky Road", Building_Number: 216, icecream:["Cookies & Cream"] }),
  new Store({_id: "Sundae #4", City: "Cherry", State: "NH", Street: "Dairy Ave", Building_Number: 305, icecream:["Cookies & Cream"] }),
  new Store({_id: "Fundae #5", City: "Sprinkles", State: "PA", Street: "Strawberry Lane", Building_Number: 5, icecream:["Cookies & Cream"] })
];
